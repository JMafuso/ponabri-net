...
A API Ponabri está hospedada no Azure App Service, URL "https://ponabriapiapp-ggdbf5fagphpfzc8.brazilsouth-01.azurewebsites.net/swagger/index.html" utilizando um plano que entra em estado ocioso após períodos de inatividade devido ao plano Free que não permite o "Always On" habilitado.
